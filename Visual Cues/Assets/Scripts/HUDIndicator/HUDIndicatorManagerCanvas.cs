...
/// Implementation of HUDIndicatorManager for Canvas.
/// </summary>
namespace Greyman
{
	public class HUDIndicatorManagerCanvas : HUDIndicatorManager
	{
		...
		void Start()
		{
			...
			{
				Debug.LogError("HUDIndicator Canvas field requieres a Canvas GameObject");
				Debug.Break();
			}
