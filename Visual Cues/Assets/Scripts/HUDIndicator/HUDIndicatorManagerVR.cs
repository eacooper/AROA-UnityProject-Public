...
/// Implementation of HUDIndicatorManager for VR. Tested only on Oculus Rift.
/// </summary>
namespace Greyman
{
	public class HUDIndicatorManagerVR : HUDIndicatorManager
	{
        ...
        {
			Debug.Log("Hiding HUD indicators.");

			indicatorsParentObj.SetActive(false);
			/*
			foreach (ArrowIndicator Indicator in arrowIndicators)
            {
				Indicator.arrow.SetActive(false);
            }
			*/
        }
        ...
        {
			Debug.Log("Showing HUD indicators.");

			indicatorsParentObj.SetActive(true);

			/*
			foreach (ArrowIndicator Indicator in arrowIndicators)
			{
				Indicator.arrow.SetActive(true);
			}
			*/
		}
